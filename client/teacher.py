...
class Teacher:
    ...
    def train(self):
        ...
        for t in range(1000):
            ...
            rank_choose = np.random.choice(np.arange(15), p=self.branch_pmf)
            next_branch = branch_scores[rank_choose]
            self.emu.savestate.load(next_branch[2])
            self.emu.savestate.save(BASE_SAVESTATE)
            post_progress_score = self.get_reward_memory()

            if len(delta_progress) > 2 and delta_progress[-1] <= 0 and delta_progress[-2] <= 0 and delta_progress[-3] <= 0:
                break
    ...
    def get_current_reward(self):
        ...
        pixels_bot = np.asarray(self.emu.screenshot().crop((127, 250, 128, 280)))
    ...
    def simulate_branches(self):
        ...
        branches = [(30, 32), (30, 32), (25, 32), (20, 32),(15, 32), (10, 32), (5, 32), (0, 0),
                    (5, 16), (10, 16), (15, 16), (20, 16), (25, 16), (30, 16), (30, 16)]
        branch_scores = []
